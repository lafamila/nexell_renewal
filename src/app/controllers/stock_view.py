...
def ts_index_page():
    return render_template('stock_TS.html', title="창고현황(공조) | 넥셀시스템", _type='ts', **refresh_code_list())

@bp.route('/bi')
@session_helper.session_check
def bi_index_page():
    return render_template('stock_BI.html', title="창고현황(빌트인) | 넥셀시스템", _type='bi', **refresh_code_list())
