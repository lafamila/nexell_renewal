...
@bp.route("/ajax_get_contract_etc", methods=["GET"])
def ajax_get_contract_etc():
    try:
        params = request.args.to_dict()
        result = dict()
        result["data"] = prj.get_contract_etc(params)
        result["status"] = True
        return jsonify(result)
    except Exception as e:
        print(e)
...
@bp.route("/ajax_insert_contract_etc", methods=["POST"])
def ajax_insert_contract_etc():
    try:
        params = request.form.to_dict()
        prj.insert_contract_etc(params)
        return jsonify({"status": True, "message": "성공적으로 추가되었습니다."})
    except Exception as e:
        print(e)
        return make_response(str(e), 500)
...
@bp.route("/ajax_update_contract_etc", methods=["POST"])
def ajax_update_contract_etc():
    try:
        params = request.form.to_dict()
        prj.update_contract_etc(params)
        return jsonify({"status": True, "message": "성공적으로 수정되었습니다."})
    except Exception as e:
        print(e)
        return make_response(str(e), 500)
...
@bp.route("/ajax_delete_contract_etc", methods=["GET"])
def ajax_delete_contract_etc():
    try:
        params = request.args.to_dict()
        prj.delete_contract_etc(params)
        return jsonify({"status": True, "message": "성공적으로 삭제되었습니다."})
    except Exception as e:
        print(e)
        return make_response(str(e), 500)
...
@bp.route("/ajax_get_reportRD", methods=["GET"])
def ajax_get_reportRD():
    params = request.args.to_dict()
    result = {}
    result["contract"] = prj.get_contract(params)
    result["project"] = prj.get_project(params)
    ...
    cCostList = list(prj.get_a_cost_list(params)) + prj.get_max_extra_cost_list(params)
    cCostListBySn = {}
    for cCost in cCostList:
        if "extra_sn" in cCost:
            extra_sn = int(cCost["extra_sn"])
        else:
            extra_sn = 0
        if extra_sn not in cCostListBySn:
            cCostListBySn[extra_sn] = list()
        cCostListBySn[extra_sn].append(cCost)
    result["cCostList"] = cCostListBySn
    result["outsrcList"] = prj.get_outsrc_report_list(params)
    result["outsrcEtcList"] = prj.get_outsrc_etc_report_list(params)
    result["progress"] = prj.get_contract_progress(params)
    result["rcppayList"] = prj.get_rcppay_report_RD_list(params)
    rcppayEtcList = prj.get_contract_etc_list(params)
    rcppayEtcListByBcnc = {}
    for rcppayEtc in rcppayEtcList:
        bcnc_sn = rcppayEtc["bcnc_sn"]
        if bcnc_sn not in rcppayEtcListByBcnc:
            rcppayEtcListByBcnc[bcnc_sn] = list()
        rcppayEtcListByBcnc[bcnc_sn].append(rcppayEtc)
    result["rcppayEtcList"] = rcppayEtcListByBcnc
    result["etcRcppayList"] = prj.get_etc_rcppay_report_list(params)
    result["typeRcppayList"] = prj.get_taxbil_report_list(params)
    result["s4AccountList"] = prj.get_s4_RD_account_report_list(params)
    result["status"] = True
    # 1084 101
    return jsonify(result)
...
def ajax_get_reportNR():
    try:
        ...
        for outsrc in result["outsrcList"]:
            ...
            result["outsrcItem"][outsrc["outsrc_fo_sn"]] = prj.get_outsrc_detail(
                s_params
            )
...
def ajax_get_reportBD():
    try:
        ...
        result["si3ListLength"] = sum(
            [
                1 if "rcppay" not in s else len(s["rcppay"])
                for s in s3TaxbilList.values()
            ]
        )
...
@bp.route("/ajax_get_contract_progress", methods=["GET"])
def ajax_get_contract_progress():
    try:
        params = request.args.to_dict()
        result = dict()
        result["data"] = {d["step"]: d for d in prj.get_contract_progress(params)}
        result["status"] = True
        return result
    except Exception as e:
        print(e)
...
@bp.route("/ajax_get_contract_etc_list", methods=["GET"])
def ajax_get_contract_etc_list():
    try:
        params = request.args.to_dict()
        result = dict()
        result["data"] = prj.get_contract_etc_list(params)
        result["status"] = True
        return result
    except Exception as e:
        print(e)
...
@bp.route("/ajax_update_contract_progress", methods=["POST"])
def ajax_update_contract_progress():
    try:
        params = request.form.to_dict()
        prj.update_contract_progress(params)
...
@bp.route("/insert_RD_b_project", methods=["POST"])
def insert_RD_b_project():
    try:
        params = request.get_json()
        prj.insert_RD_b_project(params)
        return jsonify({"status": True, "message": "성공적으로 처리되었습니다."})
    except Exception as e:
        print(e)
        return make_response(str(e), 500)
...
@bp.route("/insert_RD_c_project", methods=["POST"])
def insert_RD_c_project():
    try:
        params = request.get_json()
        prj.insert_RD_c_project(params)
        return jsonify({"status": True, "message": "성공적으로 처리되었습니다."})
    except Exception as e:
        print(e)
        return make_response(str(e), 500)
